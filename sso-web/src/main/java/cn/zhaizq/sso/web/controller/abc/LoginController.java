...
public class LoginController extends BaseController {
    ...
    public SsoResponse<String> public_key(@RequestParam String name) throws NoSuchAlgorithmException {
    ...
    @ResponseBody
    public SsoResponse<String> do_login(@PathVariable String appId, @RequestBody SsoLoginRequest loginRequest) throws BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, IOException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
